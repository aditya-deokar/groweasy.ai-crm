...
CREATE INDEX "ai_prompt_versions_feature_idx" ON "ai_prompt_versions" USING btree ("feature");--> statement-breakpoint
...
CREATE INDEX "ai_guardrail_events_rule_idx" ON "ai_guardrail_events" USING btree ("rule_id");
